...
def main(argv):
   ...
   if len(opts) + len(args) > 0:
      for opt, arg in opts:
         if opt in ("-h", "--help"):
            print 'rln [-fsPv, --force --symbolic --physical --verbose --help --version] <source> <dest> [regex]...\n'
...
def error():
   print 'Usage: rln [-fsPv, --force --symbolic --physical --verbose --help --version] <source> <dest> [regex]...\n'
   sys.exit(2)
